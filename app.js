                                  ...
                                  var mitem2 = "CORPORATE NOTIFICATIONS";
                                     if (m1.startsWith(mitem1) || m1.startsWith(mitem2)) {
                                      ...
                                      if (m1.startsWith(mitem2)) {
                                          items.push( "<b><a href='https://aquaguide.app/app/not.php'>" + val.aqua_menu  + "</a></b><br>" );
                                      }
                                  ...
                                  if (value.startsWith(space)) {
                                    ...
                                    var space8 = "Related Resources";
                                     if (value2.trim().startsWith(space1)) {
                                        items.push("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='https://aquaaerobic.github.io/share.html?id=" + val.aqua_key + "' style='font-size: 90%;'>" + val.aqua_name.trim()  + "</a><br>" );
                                       ...
                                       items.push("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- <a href='https://aquaaerobic.github.io/share.html?id=" + val.aqua_key + "' style='font-size: 90%;'>" + val.aqua_name.trim()  + "</a><br>" );
                                           ...
                                           // items.push("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='https://aquaaerobic.github.io/share.html?id=" + val.aqua_key + "'>" + val.aqua_name  + "</a><br>" );
                                            items.push("<li style='list-style-position: inside;text-size-adjust: auto;font-size: 90%;'><a href='https://aquaaerobic.github.io/share.html?id=" + val.aqua_key + "'>" + val.aqua_name  + "</a></li>" );
